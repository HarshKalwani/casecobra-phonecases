...
const DesignPreview = ({ configuration }: { configuration: Configuration }) => {
  ...
  const {mutate : createPaymentSession} = useMutation({
    mutationKey:['get-checkout-section'],
  ...
  return (
    <>
      <div
        className="pointer-events-none select-none absolute inset-0 overflow-hidden justify-center flex"
        aria-hidden="true"
      >
        <Confetti
          active={showConfetti}
      ...
      <div className="mt-20 grid grid-cols-1 text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12">
        ...
        <div className="sm:col-span-12 md:col-span-9 text-base">
          <div className="grid grid-cols-1 gap-y-8 border-b border-gray-200 py-8 sm:grid-cols-2 sm:gap-x-6 sm:py-6 md:py-10">
            <div>
              <p className="font:md text-zinc-950">Highlights</p>
              <ol className="mt-3 text-zinc-700 list-disc list-inside">
                <li className="">Wireless charging compatible</li>
                <li>TPU shock absorption</li>
                <li>Packaging made from recycle materials </li>
                <li>5yrs print warranty</li>
              </ol>
            </div>
