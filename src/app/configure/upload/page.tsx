...
const Page = () => {
  ...
  const onDropRejected = (rejectedFiles : FileRejection[]) => {
    ...
    toast({
      ...
      description:"Please use a PNG, JPEG or JPG image instead",
      variant:'destructive'
    })
  };
          ...
          {({ getRootProps, getInputProps }) => (
            ...
            >
              ...
              {isDragOver ? (
                ...
                <Loader2 className="animate-spain h-6 w-6 text-zinc-500 mb-2" />
              ) : (
              ...
              {
                !isPending && <p className="text-xs text-zinc-500">
                    PNG, JPEG, JPG
                </p> 
              }
            </div>
